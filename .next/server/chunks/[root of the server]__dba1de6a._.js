...
var __TURBOPACK__imported__module__$5b$externals$5d2f$jsonwebtoken__$5b$external$5d$__$28$jsonwebtoken$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/jsonwebtoken [external] (jsonwebtoken, cjs)"); // Import jsonwebtoken
;
;
;
    ...
    callbacks: {
        async jwt ({ token, account }) {
            if (account) {
                ...
                // Sign the token with jsonwebtoken
                const signedToken = __TURBOPACK__imported__module__$5b$externals$5d2f$jsonwebtoken__$5b$external$5d$__$28$jsonwebtoken$2c$__cjs$29$__["default"].sign({
                    ...token,
                    ...customClaims
                ...
                return signedToken; // Return the signed token
            }
            // Decode the token if it already exists
            if (typeof token === 'string') {
                try {
                    const decodedToken = __TURBOPACK__imported__module__$5b$externals$5d2f$jsonwebtoken__$5b$external$5d$__$28$jsonwebtoken$2c$__cjs$29$__["default"].verify(token, process.env.NEXTAUTH_SECRET);
                    return decodedToken;
                } catch (err) {
        ...
        async session ({ session, token }) {
            ...
            if (typeof token === 'string') {
                const decodedToken = __TURBOPACK__imported__module__$5b$externals$5d2f$jsonwebtoken__$5b$external$5d$__$28$jsonwebtoken$2c$__cjs$29$__["default"].verify(token, process.env.NEXTAUTH_SECRET);
                session.user.accessToken = decodedToken.accessToken;
                session.user.userId = decodedToken.userId; // Attach custom claims
            } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dba1de6a._.js.map